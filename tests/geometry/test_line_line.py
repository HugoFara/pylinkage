...
class TestLineLineIntersection:
    ...
    def test_coincident_lines(self):
        ...
        result = line_line_intersection(
            ...
            1.0,
            3.0,
            3.0,  # Line 2 (same line, different points)
        )
    ...
    def test_intersection_outside_segment(self):
        ...
        result = line_line_intersection(
            ...
            0.0,
            0.1,
            0.1,  # Line 1: short segment near origin
            10.0,
            0.0,
            10.1,
            0.1,  # Line 2: short segment far from origin
        )
    ...
    def test_obtuse_angle_intersection(self):
        ...
        result = line_line_intersection(
            ...
            0.0,
            10.0,
            1.0,  # Line 1: shallow slope
            10.0,
            0.0,
            0.0,
            1.0,  # Line 2: negative shallow slope
        )
        assert result[0] == INTERSECTION_ONE
...
class TestLineLineIntersectionNumerical:
    ...
    def test_large_coordinates(self):
        ...
        result = line_line_intersection(
            ...
            1000.0,
            1001.0,
            1000.0,  # Horizontal at y=1000
            1000.5,
            999.0,
            1000.5,
            1001.0,  # Vertical at x=1000.5
        )
        assert result[0] == INTERSECTION_ONE
