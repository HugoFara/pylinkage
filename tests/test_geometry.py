...
import unittest
from pylinkage.geometry import circle_intersect, circle_line_intersection
import numpy as np


class TestCirclesIntersection(unittest.TestCase):
    """Test case for circles intersection."""

    def test_no_inter(self):
        """Test case for two circles not intersecting."""
        c1 = (2., 5, 1)
        c2 = (2, 5., 1.0)
    ...
    def test_radius_ineq(self):
        """
        Test two concentric circles with different radii don't intersect.
        """
        c1 = (2., 5, 1)
        c2 = (2, 5., 1.4)
        inter = circle_intersect(c1, c2)
